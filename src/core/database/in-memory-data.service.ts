...
export class InMemoryDataService implements InMemoryDbService {
  ...
  constructor() { }
 // We use InMemoryDbService to simulate CRUD data persistance operations w/o a real server.
 // It Intercepts angular httpclient requests,redirects them to the in-memory data store --contacts collection 
